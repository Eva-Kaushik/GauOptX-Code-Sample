...
from gauoptx.driver import run_eval, run_evaluation_in_steps  # Assuming the GauOptX specific driver
from gauoptx.mocks import MockModel  # Replace with the mock used in GauOptX
...
class BaseTestCase(unittest.TestCase):
    ...
    @patch('gauoptx.methods.BayesianOptimization._model_chooser')  # Adjust path if different in GauOptX
