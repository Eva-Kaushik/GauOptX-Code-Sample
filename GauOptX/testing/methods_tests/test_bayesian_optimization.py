...
class TestBayesianOptimization(unittest.TestCase):
    ...
    def test_one_initial_data_point(self):
        ...
        model = GauOptX.models.GPModel(max_iters=0)
    ...
    def test_infinite_distance_last_evaluations(self):
        ...
        bo = GauOptX.methods.BayesianOptimization(lambda x: x*x, domain=domain,
                                                 X=None, Y=None,
        ...
        bo2 = GauOptX.methods.BayesianOptimization(lambda x: x*x, domain=domain,
