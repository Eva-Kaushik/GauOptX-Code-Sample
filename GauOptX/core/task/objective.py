...
class SingleObjective(Objective):
    ...
    def _syncronous_batch_evaluation(self, x):
        """
        Evaluates the function at x, where x can be a single location or a batch. The evaluation is performed in parallel
        ...
        # --- time of evaluation is set to constant (=1). This is one of the hypotheses of synchronous batch methods.
