...
class TestAcquisitions(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.problem_config = {
            'objective': GauOptX.objective_examples.experimentsNd.gSobol(np.ones(input_dim)).f,
    ...
    def test_invalid_mode_type(self):
        ...
        self.assertRaises(GauOptX.core.errors.InvalidConfigError, lambda : self.check_configs())
