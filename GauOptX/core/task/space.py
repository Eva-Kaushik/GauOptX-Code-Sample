...
class Design_space(object):
    ...
    Note about the internal representation of the vatiables: for variables in which the dimensionality
...
def bounds_to_space(bounds):
    ...
    us used to keep the compatibility with previous versions of GauOptX in which only bounded continuous optimization was possible
